...
// @todo: nice handling of throtteling https://github.com/aws/aws-sdk-js/issues/402
	...
	DynamoDB.prototype.add = function(data) {
		// array: append elements at the end of list
		if (Array.isArray(data)) {
			var to_ret = {'L': [] }
			for (var i in data) {
				to_ret.L[i] = util.anormalizeValue(data[i] )
			}
		...
		if ((typeof data === "number") || (typeof data === "undefined")) {
			return new DynamoDB.Raw({
				Action: 'ADD',
				Value: util.anormalizeValue(data || 1)
			})
		}
	}
	//DynamoDB.prototype.inc = DynamoDB.prototype.add
	//DynamoDB.prototype.dec = function($data) {
	//	return this.inc( - $data )
	//}
	DynamoDB.prototype.del = function() {
		return new DynamoDB.Raw({
			Action: 'DELETE'
		})
	}
